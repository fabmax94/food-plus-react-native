...
import { Container, Header, Left, Right, Body, Title, Button, Icon, View, Fab, Text, Content, Card, CardItem } from 'native-base';
...
const ListRecipe = ({ navigation }) => {
    ...
    useEffect(() => {
        FirebaseService.getDataList(PathRecipe, (recipeList) => {
                    ...
                    renderItem={(data, rowMap) => (
                        <View style={styles.rowFront}>
                            <Card key={data.item.key}>
                                ...
                                {data.item.image ? (
                                    <CardItem cardBody>
                                        <Image source={{ uri: data.item.image }} style={{ height: 200, width: null, flex: 1 }} />
                                    </CardItem>
                                ) : (null)}
                                <CardItem>
                                    <Left>
